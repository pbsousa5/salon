...
return array(
    ...
    'BackOrderTableSeeder' => $baseDir . '/database/seeds/BackOrderTableSeeder.php',
    'BackProductTableSeeder' => $baseDir . '/database/seeds/BackProductTableSeeder.php',
    'BannerTableSeeder' => $baseDir . '/database/seeds/BannerTableSeeder.php',
    'BarberProductTableSeeder' => $baseDir . '/database/seeds/BarberProductTableSeeder.php',
    'BarberTableSeeder' => $baseDir . '/database/seeds/BarberTableSeeder.php',
    'ConsumeLogTableSeeder' => $baseDir . '/database/seeds/ConsumeLogTableSeeder.php',
    'ConsumerCouponTableSeeder' => $baseDir . '/database/seeds/ConsumerCouponTableSeeder.php',
    'ConsumerTableSeeder' => $baseDir . '/database/seeds/ConsumerTableSeeder.php',
    'ConsumerWatchTableSeeder' => $baseDir . '/database/seeds/ConsumerWatchTableSeeder.php',
    'CouponTableSeeder' => $baseDir . '/database/seeds/CouponTableSeeder.php',
    'CrateUserTable' => $baseDir . '/database/migrations/2015_12_04_214516_crate_user_table.php',
    ...
    'FundAccountTableSeeder' => $baseDir . '/database/seeds/FundAccountTableSeeder.php',
    'FundRecordTableSeeder' => $baseDir . '/database/seeds/FundRecordTableSeeder.php',
    ...
    'LoginLogTableSeeder' => $baseDir . '/database/seeds/LoginLogTableSeeder.php',
    'NotifyTableSeeder' => $baseDir . '/database/seeds/NotifyTableSeeder.php',
    'OrderActionTableSeeder' => $baseDir . '/database/seeds/OrderActionTableSeeder.php',
    'OrderInfoTableSeeder' => $baseDir . '/database/seeds/OrderInfoTableSeeder.php',
    ...
    'ReviewTagTableSeeder' => $baseDir . '/database/seeds/ReviewTagTableSeeder.php',
    ...
    'SupplierCacheTableSeeder' => $baseDir . '/database/seeds/SupplierCacheTableSeeder.php',
    'SupplierManagerTableSeeder' => $baseDir . '/database/seeds/SupplierManagerTableSeeder.php',
    'SupplierTableSeeder' => $baseDir . '/database/seeds/SupplierTableSeeder.php',
    'TestCase' => $baseDir . '/tests/TestCase.php',
    'Text_Template' => $vendorDir . '/phpunit/php-text-template/src/Template.php',
    'VersionAppTableSeeder' => $baseDir . '/database/seeds/VersionAppTableSeeder.php',
    'WithdrawCashLogTableSeeder' => $baseDir . '/database/seeds/UserTableSeeder.php',
);
