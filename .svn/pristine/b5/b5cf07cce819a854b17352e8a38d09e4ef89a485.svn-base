...
namespace App\Libary\Pay\Alipay\Lib;
...
class AlipayCore
{
    ...
    public static function charsetEncode($input, $_output_charset, $_input_charset)
    {
    	...
    	if ($_input_charset == $_output_charset || $input ==null) {
    	    ...
    	    throw new AlipayException("sorry, you have no libs support for charset change.");
    	}
    ...
    public static function charsetDecode($input, $_input_charset, $_output_charset)
    {
    	...
    	if($_input_charset == $_output_charset || $input ==null ) {
    	    ...
    	    throw new AlipayException("sorry, you have no libs support for charset changes.");
    	}
