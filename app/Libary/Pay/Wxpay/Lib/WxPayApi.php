...
namespace App\Libary\Pay\Wxpay\Lib;

use App\Libary\Pay\Wxpay\Lib\Data\WxPayResults;
use App\Libary\Pay\Wxpay\Lib\Data\WxPayReport;
use App\Libary\Pay\Wxpay\Lib\Data\WxPayUnifiedOrder;
use App\Libary\Pay\Wxpay\Lib\Data\WxPayOrderQuery;
use App\Libary\Pay\Wxpay\Lib\Data\WxPayCloseOrder;
use App\Libary\Pay\Wxpay\Lib\Data\WxPayRefund;
use App\Libary\Pay\Wxpay\Lib\Data\WxPayRefundQuery;
use App\Libary\Pay\Wxpay\Lib\Data\WxPayDownloadBill;
use App\Libary\Pay\Wxpay\Lib\Data\WxPayMicroPay;
use App\Libary\Pay\Wxpay\Lib\Data\WxPayReverse;
use App\Libary\Pay\Wxpay\Lib\Data\WxPayBizPayUrl;
use App\Libary\Pay\Wxpay\Lib\Data\WxPayShortUrl;
/**
 * 
...
class WxPayApi
{
	...
	{		
		...
		//如果有配置代理这里就设置代理
		if(
		    config('wxpay.curl_proxy_host') != "0.0.0.0" &&
