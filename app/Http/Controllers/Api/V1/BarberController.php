...
class BarberController extends ApiBaseController
{
    ...
    public function login()
    {
        ...
        // 如果理发师处于解绑或首次登陆状态，并且存在预约绑定的门店，则返回该门店所有项目
        if (
        ...
        $this->barberSer->handleData($barber, '');
    ...
    public function show(Request $request, $id)
    {
        ...
        $inputs = array_remove_keys($inputs, ['id']);
        $this->barberSer->handleData($barber, '', $inputs);
